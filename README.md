...
### 版本 0.4.0
- **支持3+ AI文明**：游戏现在支持最多8个文明，可通过`civ_configs`参数配置
- **并行回合处理**：文明回合现在使用线程并行处理，减少等待时间
- **AI多文明决策**：AI现在考虑所有其他文明的信息，做出更全面的决策
- **动态UI生成**：Web界面根据活跃文明数量动态生成文明面板
- **优化的多文明交互**：文明间可进行全方位的贸易、战争和文化影响
...
- [0.4.0版本更新](announcements/0.4.0.md) (2026-03-18)
